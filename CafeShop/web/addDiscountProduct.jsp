<%-- 
    Document   : addDiscountProduct
    Created on : Jun 13, 2021, 1:50:16 AM
    Author     : thanh
--%>
...
<html lang="en">
    ...
    <body>
        <div class="main">            
            <form action="addDiscountProduct" method="POST">
                <span class="title">Tạo sản phẩm khuyến mãi mới</span>               
                ...
                <span class="title8">Sự kiện:</span>               
                <input name="eventID" class="txtsold" type="text"/>
